...
from tiendaAgua.views import index_view, eliminar_empleado_view, modificar_empleado_view, agregar_empleado_view, listar_empleados_view, modificar_view, modificar_cliente_view, eliminar_view, agregar_cliente_view, listar_cliente_view,  eliminar_view, agregar_view, certificacion_view, contactanos_view, inicio_view, listar_view, sobrenosotros_view
...
urlpatterns = [
    ...
    path('eliminar_cliente/<int:id>/',eliminar_view, name = 'eliminar_cliente'),
